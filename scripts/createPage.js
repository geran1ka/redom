  ...
  return el('div', {className: 'container'},
    el('div', {className: 'creditcard'},
      el('div', {className: 'front'},
        [el('div', {id: 'ccsingle'}), drawning ]))
  )
};

const drawning = svg("svg", {version:"1.1", id:"cardfront", xmlns:"http://www.w3.org/2000/svg", "xmlns:xlink":"http://www.w3.org/1999/xlink", x:"0px", y:"0px", viewBox:"0 0 750 471", style:"enable-background:new 0 0 750 471;", "xml:space":"preserve",},
  svg('g', {id:"Front"},
